...
import dev.incusspawn.tool.AiderSetup;
...
public final class RuntimeServices {
    ...
    private static final List<ToolSetup> TOOL_SETUPS = List.of(new ClaudeSetup(), new GhSetup(), new PiSetup(), new BobSetup(), new CodexSetup(), new AiderSetup());
